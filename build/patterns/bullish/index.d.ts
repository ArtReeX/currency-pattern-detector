declare const _default: {
    ...
    InvertedHammerStick: (candles: import("../../types").ICandle[]) => boolean;
    MorningDojiStar: (candles: import("../../types").ICandle[]) => boolean;
    MorningStar: (candles: import("../../types").ICandle[]) => boolean;
